  ...
  return (
    <article className="activities">
      ...
      <section>
        ...
        <a style={{ ...style, backgroundImage: getBackgroundImage(boten) }} href="http://www.hetwadop.nl/" target="_blank" rel="noopener noreferrer">Garnalen vissen</a>
        ...
        <a style={{ ...style, backgroundImage: getBackgroundImage(fietsen) }} href="http://www.waddenhaventexel.nl/havenplezier/de-bevoorrading" target="_blank" rel="noopener noreferrer">Fietsen verhuur</a>
      </section>
    </article>
  );
}
